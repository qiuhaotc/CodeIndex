...
namespace CodeIndex.Test
{
    public class IndexInitializerTest : BaseTest
    {
        ...
        //    var codeSources = IndexBuilderHelper.GetAllIndexedCodeSource(Config.LuceneIndexForCode);
        ...
        //    codeSources = IndexBuilderHelper.GetAllIndexedCodeSource(Config.LuceneIndexForCode);
        //    Assert.AreEqual(2, codeSources.Count);
